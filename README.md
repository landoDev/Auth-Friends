...
* Take a look at the endpoints that our API has to offer in `server.js`.
  ...
  * **[POST]** * to `/api/login`: returns a token to be added to the header of all other requests. Pass in the following credentials as the `body` of the request: `{ username: 'lando', password: 'popular' }`
